                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                        echo "<a href='update.php?id=". $row['id_cliente'] ."' title='Actualizar' data-toggle='tooltip'><span class='fas fa-pencil-alt'></span></a>";
                                        echo "<a href='delete.php?id_empleado=". $row['id_cliente'] ."' title='Borrar' data-toggle='tooltip'><span class='fas fa-trash'></span></a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
