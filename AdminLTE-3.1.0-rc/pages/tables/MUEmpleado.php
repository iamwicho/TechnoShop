<div id="MUEmpleado" class="modal fade" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3>Actualizar registro de <b>Empleado</b></h3>
            </div>
            <div class="modal-body">
                ...
                <form method="POST" action="updateEmpleado.php">
                    <div class="col-md-6">
                        <label>Nombre:</label>
                        <input type="hidden" name="id_Empleado" id="update_idE" class='form-control' maxlength="100" required >
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="submit" name="updateEmpleado" class="btn btn-success" value="Actualizar">
                    </div>
                </form>
            </div>
        </div>
